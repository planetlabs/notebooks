...
<a href="https://docs.planet.com/data/planet-sandbox-data/" target="_blank">Planet Sandbox Data landing page</a> provides an overview documentation of each of the collections including the temporal and geographic coverage. Users can also log in to <a href="https://apps.sentinel-hub.com/eo-browser/?zoom=12&lat=42.13668&lng=11.76636&themeId=PLANET_SANDBOX&tutorialIdToShow=PSD_TUTORIAL#highlights" target="_blank">EO Browser</a> to easily browse and visualize the Sandbox Data.  
  ...
  <div style="display: flex; justify-content: space-between; align-items: center;">
    <div style="display: flex; align-items: center; flex: 0 0 50%; padding-right: 20px;">
      ...
      <p style="font-size: 16px; margin: 0; line-height: 1.5;">
        These notebooks make use of <a href="https://docs.planet.com/data/planet-sandbox-data/" target="_blank">Planet Sandbox Data</a>. You need a Planet account in order to access this data. If you don't already have an account, you can <a href="https://insights.planet.com/sign-up/" target="_blank">create a free 30 day trial</a>.
      </p>
    </div>
